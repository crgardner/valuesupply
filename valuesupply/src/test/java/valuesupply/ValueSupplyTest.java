...
public class ValueSupplyTest {
    ...
    public void test() {
        ...
        verify(consumer).provide(httpHeaderCategory, new ImmutableMap.Builder<String, Supplier<String>>().put(arrivalName, helloSupplier)
                                                                                                         .put(approachingName, onTheWaySupplier).build());
        verify(consumer).provide(urlComponentCategory, new ImmutableMap.Builder<String, Supplier<String>>().put(departureName, goodbyeSupplier).build());
    }
